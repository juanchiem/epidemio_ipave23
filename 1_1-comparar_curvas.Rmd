...
Graficamos los 3 modelos con los mismos coeficientes
...
La predicción de $y$ para $t=15$ para los 3 modelos , la obtendríamos por despeje de la ecuación, o bien aplicando la función recientemente creada.  
...
Definición matemática de los modelos logistico, gompertz e monomolecular (3 parámetros)
...
Nuevamente graficamos los 3 modelos con los mismos coeficientes
...
La predicción de $y$ para $t=15$ para los 3 modelos seria:
...
Graficamos dos curvas logisticas con igual $r$ (0.5) pero diferente $k$ (0.6 y 0.8):
